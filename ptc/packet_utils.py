...
class PacketDecoder(object):
    ...
    def decode(self, packet_bytes):
        ...
        source_port = self.decode_source_port_on(transport_packet_bytes)
        destination_port = self.decode_destination_port_on(transport_packet_bytes)
        seq_number = self.decode_seq_number_on(transport_packet_bytes)
        ack_number = self.decode_ack_number_on(transport_packet_bytes)
        flags = self.decode_flags_on(transport_packet_bytes)
        window_size = self.decode_window_size_on(transport_packet_bytes)
        data = self.decode_data_on(transport_packet_bytes)
